...
python -u predict.py -in "/gpfs/soma_fs/scratch/src/boeger/data_gueniz/ErenBoeger_2024" -p ${1} -o "/gpfs/soma_fs/scratch/src/boeger/PpaPred_eren_35727184/ErenBoeger_2024" -id $SLURM_JOB_ID
